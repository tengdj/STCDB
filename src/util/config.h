...
public:
    ...
    uint kv_capacity = 134217728*2.5 + 1000000;            //134217728 + 1000000
    uint kv_restriction = 134217728*2.5;                  //2*1024*1024*1024/16 = 134217728
    uint MemTable_capacity = 5*2;             //5*2 ,but workbench data[100]
