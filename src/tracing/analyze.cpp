...
//		}
	...
	if(pro.rounds>0){
        ...
        fprintf(stderr,"\tcuda search single:\t%.2f\n",pro.cuda_search_single_kv_time);
        fprintf(stderr,"\tcuda search multi:\t%.2f\n",pro.cuda_search_multi_kv_time);
        fprintf(stderr,"\tsearch memtable:\t%.2f\n",pro.search_memtable_time);
        ...
        fprintf(stderr,"\toverall :\t%.2f\n",(pro.copy_time+pro.partition_time+pro.filter_time+pro.refine_time+pro.meeting_identify_time+pro.index_update_time
                                                           +pro.cuda_sort_time+pro.cuda_search_single_kv_time + pro.cuda_search_multi_kv_time));
