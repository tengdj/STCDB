#ifndef SRC_INDEX_RTREE_H_
#define SRC_INDEX_RTREE_H_
...
public:
  ...
  size_t Search(const ELEMTYPE a_min[NUMDIMS], const ELEMTYPE a_max[NUMDIMS], bool a_resultCallback(DATATYPE a_data, box poly_mbr, void* a_context), void* a_context);
...
protected:
  ...
  bool Search(Node* a_node, Rect* a_rect, size_t& a_foundCount, bool  a_resultCallback(DATATYPE a_data, box poly_mbr, void* a_context), void* a_context);
...
RTREE_TEMPLATE
size_t RTREE_QUAL::Search(const ELEMTYPE a_min[NUMDIMS], const ELEMTYPE a_max[NUMDIMS], bool a_resultCallback(DATATYPE a_data, box poly_mbr, void* a_context), void* a_context)
{
#ifdef _DEBUG
  for(int index=0; index<NUMDIMS; ++index)
  {
...
RTREE_TEMPLATE
bool RTREE_QUAL::Search(Node* a_node, Rect* a_rect, size_t & a_foundCount, bool  a_resultCallback(DATATYPE a_data, box poly_mbr, void* a_context), void* a_context)
{
  ASSERT(a_node);
